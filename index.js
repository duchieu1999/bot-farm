...
const allowedGroupIds = [
  -1002230199552, -1002360155473, -1002392685048, -1002457468797, -1002383656659, -1002168066817, -1002449707024, -1002479414582, -1002160116020, -1002259135527, -1002349272974, -1002312409314, -1002439441449, -1002178207739, -1002235474314, -1002186698265, -1002205826480,
...
const timeSlots = [
  ...
  { time: '18:41', label: 'ca 18h30' },
  { time: '19:22', label: 'ca 20h00' }
];
...
timeSlots.forEach((slot, index) => {
  ...
  for (const [name, data] of existingMembers) {
    if (name !== memberName) { // Chỉ kiểm tra số trùng với thành viên khác
  ...
  if (duplicateNumbers.length > 0) {
    for (const [name, data] of existingMembers) {
      if (name !== memberName) { // Không xóa số của thành viên hiện tại
